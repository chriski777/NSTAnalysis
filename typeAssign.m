...
%   Output: a cell of corresponding 
    ...
    spikeIndex = find(~cellfun(@isempty,strfind(firstRow, 'FullSpikes')));
    stdISIIndex = find(~cellfun(@isempty,strfind(firstRow, 'FullStDevISI')));
    ...
    remFirst(:,sort([spikeIndex,stdISIIndex])) = cellMats;
